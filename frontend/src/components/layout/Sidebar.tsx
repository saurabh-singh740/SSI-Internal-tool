...
import {
  ...
  ChevronRight, Briefcase, Clock, BarChart2, DollarSign, X,
} from 'lucide-react';
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-ink-100 leading-tight truncate">Cohort Admin</p>
            <p className="text-xs text-ink-500">Project Platform</p>
          </div>
        </div>
