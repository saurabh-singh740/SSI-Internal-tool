...
import {
  ...
  CreditCard, Activity, Banknote, ShieldCheck, Settings2, StickyNote,
} from 'lucide-react';
        ...
        <Section icon={ShieldCheck} title="Client Access">
          <div className="space-y-5">
            ...
            <div className="pt-5" style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
              ...
              <p className="text-xs text-ink-500 mb-3">Customers can view these sections but cannot edit any data.</p>
              <div className="space-y-3">
