...
const Pipeline                 = lazy(() => import('./pages/presales/Pipeline'));
const DealDetail               = lazy(() => import('./pages/presales/DealDetail'));
  ...
  return (
    ...
    <Routes>
      ...
      >
        ...
        {/* Pre-Sales — admin only */}
        <Route path="presales" element={<ProtectedRoute adminOnly><Pipeline /></ProtectedRoute>} />
        <Route path="presales/:id" element={<ProtectedRoute adminOnly><DealDetail /></ProtectedRoute>} />
        <Route path="partners" element={<ProtectedRoute adminOnly><Partners /></ProtectedRoute>} />
